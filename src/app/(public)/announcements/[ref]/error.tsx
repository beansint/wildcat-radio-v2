...
/**
 * FE#36 — `/announcements/[ref]` error boundary. Distinct from the
 * *expected* not-found branch already handled inline in `page.tsx` via
    ...
    <div className="wc-container py-10">
      ...
      >
        <p className="font-semibold text-destructive">
          This announcement couldn&apos;t be loaded.
        </p>
        {error.digest ? (
