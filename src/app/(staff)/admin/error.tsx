...
/**
 * FE#36 — `/admin` segment error boundary. Same shape as `/mod`'s —
 * `(staff)/admin/layout.tsx` stays mounted around this (StaffSidebar +
 * `wc-shell`/`wc-main`, dark-by-default), so this only fills the `wc-main`
 * content area.
 *
      ...
      >
        ...
        <div className="flex gap-3">
          ...
          <Button asChild variant="outline">
            <Link href="/admin/escalations">Back to escalations</Link>
          </Button>
        </div>
      </div>
    </div>
